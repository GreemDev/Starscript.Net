...
public partial struct Parser
{
...
#if DEBUG
            DebugLog(
                $"Expr {nameof(Expr.Logical)} created: Start {start}, End {_previous.End}, LeftType {expr.ExprName} Operator {Enum.GetName(Token.And)}, RightType {right.ExprName}");
#endif
...
#if DEBUG
            DebugLog(
                $"Expr {nameof(Expr.Logical)} created: Start {start}, End {_previous.End}, LeftType {expr.ExprName} Operator {Enum.GetName(Token.Or)}, RightType {right.ExprName}");
#endif
...
#if DEBUG
            DebugLog(
                $"Expr {nameof(Expr.Unary)} created: Start {start}, End {_previous.End}, Operator {Enum.GetName(op)}, RightType {right.ExprName}");
#endif
    ...
    private Expr Call()
    {
        ...
        if (expr is Expr.Get getExpr)
            DebugLog(
                $"Expr {nameof(Expr.Get)} created: Start {start}, End {end}, PrimaryType {getExpr.Object.ExprName}");
#endif
...
#if DEBUG
            DebugLog(
                $"Expr {nameof(Expr.String)} created: Start {_previous.Start}, End {_previous.End}, Lexeme '{_previous.Lexeme}'");
#endif
...
#if DEBUG
            DebugLog(
                $"Expr {nameof(Expr.Boolean)} created: Start {_previous.Start}, End {_previous.End}, Lexeme '{_previous.Lexeme}', Value {_previous.Lexeme.Equals("true")}");
#endif
...
#if DEBUG
            DebugLog(
                $"Expr {nameof(Expr.Variable)} created: Start {_previous.Start}, End {_previous.End}, Lexeme '{_previous.Lexeme}'");
#endif
...
#if DEBUG
            DebugLog(
                $"Expr {nameof(Expr.Group)} created: Start {start}, End {_previous.End}, ExprType {expr.ExprName}");
#endif
...
#if DEBUG
            DebugLog(
                $"Expr {expr.ExprName} created: Start {start}, End {_previous.End}, ExpressionDepth {_expressionDepth}, " +
